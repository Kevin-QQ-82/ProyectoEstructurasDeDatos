...
public class GameLoader {
    ...
    public static CircularDoublyLinkedList<Juego> cargarJuegos() {
        ...
        juegos.addFirst(new Juego("Apex Lengeds", "Apex Legends is the award-winning, free-to-play Hero Shooter from Respawn Entertainment. Master an ever-growing roster of legendary characters with powerful abilities, and experience strategic squad play and innovative gameplay in the next evolution of Hero Shooter and Battle Royale.", "ACCION", null, "EA Electronics",  "2020/11/4"));
        juegos.addLast(new Juego("Doom Eternal", "Hell’s armies have invaded Earth. Become the Slayer in an epic single-player campaign to conquer demons across dimensions and stop the final destruction of humanity. The only thing they fear... is you", "ACCION", null, "Bethesda Softworks",  "2020-Mar-4"));
        juegos.addLast(new Juego("COD Warzone 2.0", "Welcome to Warzone™ 2.0, the massive free-to-play combat arena which now features the brand-new map, Al Mazrah.", "ACCION", null, "Activision", "2022-Nov-16"));
        juegos.addLast(new Juego("FIFA 23", "Experience the excitement of the biggest tournament in football with EA SPORTS™ FIFA 23 and the men’s FIFA World Cup™ update, available on November 9 at no additional cost!","DEPORTES", null, "EA Electronics",  "2022-Sep-19"));
        juegos.addLast(new Juego("Terraria", "Dig, fight, explore, build! Nothing is impossible in this action-packed adventure game. Four Pack also available!","ACCION", null, "Re-Logic", "2011-May-16"));
        juegos.addLast(new Juego("Stray", "Lost, alone and separated from family, a stray cat must untangle an ancient mystery to escape a long-forgotten cybercity and find their way home.", "INDIE", null, "Annapurna Interactive",  "2022-Jul-19"));
        juegos.addLast(new Juego("Dead by Daylight", "Dead by Daylight is a multiplayer (4vs1) horror game where one player takes on the role of the savage Killer, and the other four players play as Survivors, trying to escape the Killer and avoid being caught and killed.", "HORROR", null, "Behaviour Interactive Inc.", "2016-Jun-14"));
        juegos.addLast(new Juego("NBA 2k23", "Rise to the occasion in NBA 2K23. Showcase your talent in MyCAREER. Pair All-Stars with timeless legends in MyTEAM. Build your own dynasty in MyGM, or guide the NBA in a new direction with MyLEAGUE. Take on NBA or WNBA teams in PLAY NOW and feel true-to-life gameplay.","DEPORTES", null, "EA Electronics",  "2022-Sep-22"));
        juegos.addLast(new Juego("Brawlhalla", "An epic platform fighter for up to 8 players online or local. Try casual free-for-alls, ranked matches, or invite friends to a private room. And it's free! Play cross-platform with millions of players on PlayStation, Xbox, Nintendo Switch, iOS, Android & Steam! Frequent updates. Over fifty Legends.", "MULTIJUGADOR", null, "Ubisoft",  "2017-Oct-17"));
        cargarReseña(juegos);
        return juegos;
    }
